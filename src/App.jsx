    ...
    <main id="main">
      <div className="leftPort">
        ...
        <Title title="Contact">
          ...
          <p>วันเกิด: {moment("2002/11/14").format("D MMM YYYY")}</p>
          ...
          <p>Email : s64122202044@ssru.ac.th</p>
        </Title>
      ...
      <div className="rightPort">
        <Title title="Profile">
          <p>อยากลองทำแอปแล้วงานใหม่ๆเพิ่มเติมในสายที่ได้เรียนมา</p>
        </Title>

        <Title title="Work Experience">
          <p>เคยทำงานพาทไทม์มาหลายที่</p>
        </Title>
